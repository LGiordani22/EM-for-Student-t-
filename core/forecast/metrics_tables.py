"""
core/forecast/metrics_tables.py

LE TABELLE, per finestra e per famiglia.  Un lettore puro: non stima niente,
legge i CSV lunghi e li aggrega.

    python -m core.forecast.metrics_tables
    python -m core.forecast.metrics_tables --window 2007-2010
...
def load_nyfed(dfm: pd.DataFrame, paths: list[str] | None = None) -> pd.DataFrame:
    ...
    """
    from core.forecast.nyfed_nowcast import load_long as _load_fed
    try:
        fed = _load_fed(paths)
