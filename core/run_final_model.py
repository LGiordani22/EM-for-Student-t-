...
Uso:
    python core/run_final_model.py --spec fed_overlap --estimator gaussian
    python core/run_final_model.py --spec diag4 --estimator student_t
"""
