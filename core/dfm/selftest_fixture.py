...
-----------------------------------
    from dfm.selftest_fixture import parse_spec_args, load_fixture
...
def load_fixture(spec_name: str = DEFAULT_SPEC, *, seed: int = 42) -> Fixture:
    ...
    from dfm.em_initialization import (  # noqa: PLC0415
    ...
    if not os.path.isfile(_DATASET):
        raise FileNotFoundError(
            ...
            f"Costruiscilo con:  python core/data_loader_final.py"
        )
