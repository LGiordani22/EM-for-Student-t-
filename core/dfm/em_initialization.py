...
try:  # package (from em.em_initialization) o script (python core/dfm/em_initialization.py)
    from dfm.factor_structure import FactorStructure, as_structure
...
def initialize_theta(
    ...
    if spec_name is not None:
        from dfm.factor_structure import build_loading_mask  # noqa: PLC0415
...
if __name__ == "__main__":
    ...
    from dfm.selftest_fixture import (
