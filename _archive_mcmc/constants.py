...
Two tables live here (see ``docs/tesi/EM_for_student_t.tex`` ``tab:omori-mixture``):
...
# Transcribed from docs/tesi/EM_for_student_t.tex, Table `tab:ksc-mixture` (the
...
# Transcribed from docs/tesi/EM_for_student_t.tex, Table `tab:omori-mixture` (Omori,
