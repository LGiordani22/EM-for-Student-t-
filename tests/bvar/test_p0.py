"""
core/bvar/tests/test_p0.py

P_0 — LA SCELTA CENTRALIZZATA, CABLATA IN UN TEST.

    python -m core.bvar.tests.test_p0
...
from core.bvar import bbvar, cbvar, lbvar, qbvar
from core.bvar import state_space as ss_mod
from core.bvar.state_space import P0_DEFAULT, initial_covariance, lyapunov_symm
