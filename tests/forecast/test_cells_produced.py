...
USO
---
    python -m core.forecast.test_cells_produced                 # i CSV raccolti
    python -m core.forecast.test_cells_produced --dir <cartella>
...
from core.forecast.weekly_nowcast import cell_health
