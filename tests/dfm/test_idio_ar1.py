...
_SRC = str(pathlib.Path(__file__).resolve().parent.parent.parent / "core")
if _SRC not in sys.path:
    sys.path.insert(0, _SRC)

from dfm.idio_ar1 import (  # noqa: E402
...
from dfm.idio_ar1 import build_augmented_A as _bA  # noqa: E402,F401
