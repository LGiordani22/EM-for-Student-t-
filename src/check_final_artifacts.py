...
USO
---
    python src/check_final_artifacts.py
    python src/check_final_artifacts.py --spec diag3
    python src/check_final_artifacts.py --quiet     # solo i problemi
...
def main() -> int:
    ...
    if rotte:
        print(f"\n{rotte} cella/e INCOERENTE/I: ricalcolale con\n"
              f"  python src/run_final_artifacts.py --spec <spec> --variant <variante>")
        return 1
    print("\nNessuna incoerenza.")
    return 0
