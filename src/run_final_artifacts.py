...
USO
---
    python src/run_final_artifacts.py --spec fed_overlap --variant student_t_ar1
    python src/run_final_artifacts.py --all --all-variants   # tutte le 15 celle
    python src/run_final_artifacts.py --all                  # solo gaussian
"""
    ...
    **Non usare `em_main.load_dfm_fit` su questi file.** Sono due formati
    ...
    if not os.path.isfile(npz_path):
        raise FileNotFoundError(
            ...
            f"Calcolala con:  python src/run_final_artifacts.py "
