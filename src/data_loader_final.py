...
USO
---
    python src/data_loader_final.py                 # scarica e salva tutto
    python src/data_loader_final.py --no-save        # solo in memoria + report
    python src/data_loader_final.py --calendar-only  # rigenera solo la tabellina
