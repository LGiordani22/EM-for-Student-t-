"""
src/bvar/tests/test_gate3.py

GATE 3, BLOCCO 1 — la mappa cube-root.

    python -m src.bvar.tests.test_gate3
...
from src.bvar.cube_root import (
    coupling_matrix,
    matrix_cube_root,
    monthly_constant,
...
from src.bvar.simulate import simulate_var, stable_var_coefficients
