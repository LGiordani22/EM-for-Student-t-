"""
src/bvar/tests/test_gate2.py

IL RECOVERY TEST DEL GATE 2: il wrapper trimestrale.

    python -m src.bvar.tests.test_gate2
...
from src.bvar.data import build_panel, load_raw_levels, to_model_units
from src.bvar.qbvar import (
    QBVARFit,
