...
from src.bvar import bbvar, cbvar, data as bdata, evaluate, lbvar, qbvar
from src.bvar.evaluate import TARGET
...
class Spy:
    ...
    def __enter__(self):
        import src.bvar.data as m_data
        import src.bvar.hyper as m_hyper
        import src.bvar.qbvar as m_qbvar
        ...
        if self.stop:
            ...
            import src.bvar.core as m_core
