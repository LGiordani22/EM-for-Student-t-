...
`src/kalman.py`.  `src/kalman.py` non si tocca (condiviso da `em/`, `mcmc/`,
...
from src.kalman import build_selection_matrix, kalman_predict, kalman_update  # noqa: F401
...
from src.bvar.state_space import kalman_update_fast
