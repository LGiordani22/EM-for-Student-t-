...
USO
---
    python src/compare_theta_star_hat.py --spec diag3 --variant student_t_ar1
    python src/compare_theta_star_hat.py --all
"""
...
from em.em_main import compute_elbo_correction                     # noqa: E402
from em.selftest_fixture import load_fixture                       # noqa: E402
