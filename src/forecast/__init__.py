"""
src/forecast/ — nowcast settimanale del PIL sul pannello `final` (37 serie).
...
# Il motore EM vive in `src/em/` e i suoi moduli si importano fra loro come
# `em.*`: perche' quelle importazioni si risolvano, `src/` deve stare sul path.
