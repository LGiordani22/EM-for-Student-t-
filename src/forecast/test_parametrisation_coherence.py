"""
src/forecast/test_parametrisation_coherence.py
...
Esegui:  python -m src.forecast.test_parametrisation_coherence
...
from src.forecast.nowcast_engine import (
    SPECS, prepare_vintage, estimate, filter_only, extract_target, nowcast,
)
from src.forecast.release_calendar import load_metadata, load_panel, quarter_end
